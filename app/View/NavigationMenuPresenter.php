...
readonly class NavigationMenuPresenter {
    ...
    private function headerItems(NavigationMenu $menu): array {
        return [
            ['title' => "$menu->activeDiscussions aktywnych dyskusji dzisiaj", 'icon' => 'navigationActiveDiscussions'],
            ['title' => "$menu->usersOnline online", 'icon' => 'navigationOnlineUsers', 'online' => true],
        ];
    }
